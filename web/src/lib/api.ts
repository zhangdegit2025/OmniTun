...
/**
 * Performs an authenticated API request. Automatically attaches JWT and handles refresh.
 *
 * @param path - API path (e.g. `/v1/tunnels`)
...
/**
 * Sets the JWT token used for authenticated API requests.
 */
...
/**
 * Clears the JWT token from the API client.
 */
