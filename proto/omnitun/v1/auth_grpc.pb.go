...
const (
	AuthService_Register_FullMethodName             = "/omnitun.v1.AuthService/Register"
	AuthService_Login_FullMethodName                = "/omnitun.v1.AuthService/Login"
	AuthService_RefreshToken_FullMethodName         = "/omnitun.v1.AuthService/RefreshToken"
	AuthService_Logout_FullMethodName               = "/omnitun.v1.AuthService/Logout"
	AuthService_GetMe_FullMethodName                = "/omnitun.v1.AuthService/GetMe"
	AuthService_EnrollMFA_FullMethodName            = "/omnitun.v1.AuthService/EnrollMFA"
	AuthService_VerifyMFA_FullMethodName            = "/omnitun.v1.AuthService/VerifyMFA"
	AuthService_RequestPasswordReset_FullMethodName = "/omnitun.v1.AuthService/RequestPasswordReset"
	AuthService_ResetPassword_FullMethodName        = "/omnitun.v1.AuthService/ResetPassword"
)
...
func (c *authServiceClient) EnrollMFA(ctx context.Context, in *EnrollMFARequest, opts ...grpc.CallOption) (*EnrollMFAResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EnrollMFAResponse)
	err := c.cc.Invoke(ctx, AuthService_EnrollMFA_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) EnrollMFA(context.Context, *EnrollMFARequest) (*EnrollMFAResponse, error) {
...
func _AuthService_EnrollMFA_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EnrollMFARequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).EnrollMFA(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_EnrollMFA_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).EnrollMFA(ctx, req.(*EnrollMFARequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "omnitun.v1.AuthService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_EnrollMFA_Handler,
		},
		{
	...
	Metadata: "omnitun/v1/auth.proto",
}
